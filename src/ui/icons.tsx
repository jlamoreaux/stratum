...
export const FileImageIcon: FC = () => (
  ...
  >
    ...
    <path
      d="M2 12L6 8L9 11L12 8L14 10V13C14 13.5523 13.5523 14 13 14H3C2.44772 14 2 13.5523 2 13V12Z"
      fill="#10b981"
    />
  </svg>
);
...
export const FileDockerIcon: FC = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    role="img"
    aria-label="Docker file"
  >
    <title>Docker file</title>
    <rect x="2" y="2" width="12" height="12" rx="2" fill="#2496ed" />
    <path
      d="M5 8H6V9H5V8ZM7 8H8V9H7V8ZM9 8H10V9H9V8ZM7 6H8V7H7V6ZM9 6H10V7H9V6ZM11 6H12V7H11V6ZM9 4H10V5H9V4ZM11 4H12V5H11V4ZM13 7H14V8H13V7ZM13 5H14V6H13V5ZM4 10H12V11H4V10Z"
      fill="white"
    />
  </svg>
);
...
export const FolderHiddenIcon: FC = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    role="img"
    aria-label="Hidden folder"
  >
    <title>Hidden folder</title>
    <path
      d="M2 4C2 3.44772 2.44772 3 3 3H6L8 5H13C13.5523 5 14 5.44772 14 6V12C14 12.5523 13.5523 13 13 13H3C2.44772 13 2 12.5523 2 12V4Z"
      stroke="#6b7280"
      strokeWidth="1.5"
    ...
    />
    <path
      d="M6 9C6 9 7 10 8 10C9 10 10 9 10 9M5.5 8L6.5 9M9.5 9L10.5 8"
      stroke="#6b7280"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const FolderDocsIcon: FC = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    role="img"
    aria-label="Documentation folder"
  >
    <title>Documentation folder</title>
    <path
      d="M2 4C2 3.44772 2.44772 3 3 3H6L8 5H13C13.5523 5 14 5.44772 14 6V12C14 12.5523 13.5523 13 13 13H3C2.44772 13 2 12.5523 2 12V4Z"
      stroke="#8b5cf6"
      strokeWidth="1.5"
...
export const FolderExamplesIcon: FC = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    role="img"
    aria-label="Examples folder"
  >
    <title>Examples folder</title>
    <path
      d="M2 4C2 3.44772 2.44772 3 3 3H6L8 5H13C13.5523 5 14 5.44772 14 6V12C14 12.5523 13.5523 13 13 13H3C2.44772 13 2 12.5523 2 12V4Z"
      stroke="#f59e0b"
      strokeWidth="1.5"

 ...
 * label is the button, and the checked state shows the links. The input is
 * visually hidden rather than display:none so it keeps its place in the tab
 * order, and the label shows its focus ring.
 */
.nav-menu-toggle {
  position: absolute;
  width: 1px;

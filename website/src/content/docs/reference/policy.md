...
description: "Every field .stratum/policy.yaml accepts — evaluators, scoring, merge protection, deploys, and every default and bound."
editUrl: "https://github.com/stratum-eng/stratum/edit/main/docs/api/policy.md"
---
...
This is the reference. [Getting started](/guides/getting-started/#3-write-your-evaluation-policy)
is the tutorial that walks you into it, and
[CI integration](/guides/ci-integration/) covers the `webhook` evaluator
in depth. Stratum's own policy —
[`.stratum/policy.yaml`](https://github.com/stratum-eng/stratum/blob/main/.stratum/policy.yaml) — is a live example the
project runs under.
...
system can be the gate. See [CI integration](/guides/ci-integration/)
...
[deployments guide](/guides/deployments/) is the full account, including

...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		POSTHOG_HOST: "https://app.posthog.com";
		OAUTH_REDIRECT_URI: "https://stratum-staging.jlmx.workers.dev/auth/github/callback" | "http://localhost:8787/auth/github/callback";
		MERGE_QUEUE: DurableObjectNamespace /* MergeQueue from stratum-staging */ | DurableObjectNamespace /* MergeQueue from stratum */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOG_HOST" | "OAUTH_REDIRECT_URI">> {}
}
